...
class NotificationCategory(str, Enum):
    ...
    INSPECTION_BOOKING_REQUESTED = "INSPECTION_BOOKING_REQUESTED"
    INSPECTION_BOOKING_APPROVED = "INSPECTION_BOOKING_APPROVED"
    INSPECTION_BOOKING_REJECTED = "INSPECTION_BOOKING_REJECTED"
    # Certificate
